 ...
 * @see https://v0.dev/t/bo9F25h7Cs1
 */
...
export function Component() {
  return (
    <div className="container grid max-w-6xl gap-10 px-4 py-8 md:grid-cols-2 md:py-16 lg:gap-16 md:gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Contact our support team: +1 (123) 456-7890</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Email us your questions: info@example.com</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
