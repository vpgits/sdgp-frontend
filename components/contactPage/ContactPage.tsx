      ...
      <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Contact our support team:  (123) bambal b</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Email us your questions: HELLINFO@hell.com</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">123 Street, PALITHA, HELL</p>
              </div>
            </div>
          </div>
        </div>
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">Stay updated with our latest news and announcements.</p>
          </div>
          <div className="flex items-center space-x-4">
