      ...
      <div className="hidden border-r bg-white lg:block dark:bg-gray-950">
        <div className="flex h-full max-h-screen flex-col gap-2">
          ...
          <nav className="grid items-start px-4 text-sm font-medium">
            ...
            <Link
              className="flex items-center gap-3 rounded-lg px-20 absolute bottom-2 left-0  text-red-500 transition-all hover:text-red-900 dark:text-red-400 dark:hover:text-red-50"
              href="#"
              style={{
                order: 1,
              }}
