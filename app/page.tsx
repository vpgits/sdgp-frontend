  ...
  return (
    <main className="flex flex-col md:flex-row items-center">
      <div className="md:w-1/2  ml-20 mt-20">
        <h1 className="text-5xl italic md:text-5xl lg:text-7xl font-playfair leading-tight mb-3">
          The Best Way To Showcase Your Skills
        </h1>
        <p className="text-xl md:text-2xl font-light mt-20">
        ...
        <div className="buttons mt-20">
          ...
          <Button className="border border-blue-500 text-blue-500 ml-20">
